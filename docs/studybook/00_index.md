...
| `M3_silver_transform.md` | M3 | 3 · Data Transformation and Modeling |
| `M4_gold_modeling.md` | M4 | 3 |
| `M5_declarative_pipelines.md` | M5 | 2, 3 |
| `M6_lakeflow_jobs.md` | M6 | 4 · Working with Lakeflow Jobs |
| `M7_cicd_bundles.md` | M7 | 5 · Implementing CI/CD |
| `M8_troubleshooting_optimization.md` | M8 | 6 · Troubleshooting/Monitoring/Optimization |
| `M9_governance_security.md` | M9 | 7 · Governance and Security |
| `M10_dashboards_and_readiness.md` | M10 | 3, 4 |
...
> objective→milestone map is `docs/04_exam_blueprint_map.md`.
